        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellingEstimate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DamagedNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Deliveries_Users_ApprovedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityApproved = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryItems_InventoryItems_InventoryItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_ApprovedByUserId",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_ReferenceNumber",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryItems_InventoryItemId",
                table: "DeliveryItems",
